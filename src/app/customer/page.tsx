...
export default function CustomerPortal() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="fixed top-0 z-50 w-full border-b bg-green-400 backdrop-blur overflow-x-hidden">
      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-green-50 to-white dark:from-green-950/20 dark:to-background overflow-x-hidden">
          <div className="container max-w-screen-xl py-5 mx-auto px-4 md:px-6">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid gap-16 lg:grid-cols-2">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-6" id="how-it-works">How It Works now and in future</h2>
      ...
      <footer className="border-t w-fu bg-black">
        <div className="container flex flex-col gap-4 py-10 md:flex-row md:items-center md:justify-between md:py-8">
          ...
          <nav className="flex gap-4 text-sm px-2 text-white text-muted-foreground">

...
import { ArrowLeft, Leaf, LineChart, Droplets, Thermometer, Info, ExternalLink } from "lucide-react"
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-green-400 backdrop-blur">
        <div className="container flex flex-wrap items-center justify-between h-auto gap-2 px-4 py-2">
          {/* Logo and Title */}
          ...
          <nav className="flex flex-wrap items-center gap-3 text-sm sm:text-base">
            <Link href="/" className="font-medium hover:underline whitespace-nowrap">
              Home
            </Link>
            <Link href="#how-it-works" className="font-medium hover:underline whitespace-nowrap">
              How It Works
            </Link>
            <Link href="#demo" className="font-medium hover:underline whitespace-nowrap">
              Demo
            </Link>
            <Link href="#purchase" className="font-medium hover:underline whitespace-nowrap">
              Purchase
            </Link>
          </nav>
        </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-2">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-6" id="how-it-works">
                  How It Works
                </h2>
                ...
                <div className="mt-8" id="demo">
                  <Card>
                    ...
                    <CardContent>
                      <p className="mb-4">
                        {"Experience a fully interactive demo of our admin dashboard with simulated data."}
                      </p>
                ...
                <div className="mt-8" id="purchase">
                  <Card className="bg-green-50 dark:bg-green-950/20 border-green-200">
                    ...
                    <CardContent>
                      <p className="mb-4">
                        {"Our complete system includes all hardware, software, and a 1-year warranty."}
                      </p>
